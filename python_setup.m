...
modules = {'numpy' ,'torch', 'graphviz', 'auto_grad_viz', 'antecedent_layer','consequent_layer', 'fuzzy_layer' , 'anfis','joint_mamdani_membership' ,'joint_membership' ,'joint_membership_optimized' , 'utils', 'trainer','loader', 'hyperparameter_search', 'ray', 'load_model'};
