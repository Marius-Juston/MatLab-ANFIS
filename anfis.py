...
class AnfisNet(torch.nn.Module):
    ...
    def __init__(self, description, invardefs, outvarnames, mamdani_out, input_keywords, number_of_mfs, hybrid=True):
        ...
        mam_varnames = [mam_v for mam_v, _ in mamdani_out]
        #print(mam_varnames)
        mam_mfdefs = [FuzzifyVariable(mam_mfs) for _, mam_mfs in mamdani_out]
        self.mam_mfdefs = [FuzzifyVariable(mam_mfs) for _, mam_mfs in mamdani_out]
        #print(mam_mfdefs)
#        print(mam_mfdefs[0].mfdefs['mf0'].a)
#        print(mam_mfdefs[1].mfdefs['mf0'].b)
#        print(mam_mfdefs[6].mfdefs['mf0'].c)
    ...
    def forward(self, x):
        ...
        #    self._coeff2[0][0][0] = self.mam_mfdefs[self.layer['rules'].mf_out[0] + 3].mfdefs['mf0'].b
